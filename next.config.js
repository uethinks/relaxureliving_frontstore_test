    ...
    return [
      {
        ...
        destination: "https://relaxureliving-frontstore-test.vercel.app/_vercel/insights/:match*",
      },
      {
        source: "/api/performance/:match*",
        destination: "https://relaxureliving-frontstore-test.vercel.app/_vercel/speed-insights/:match*",
      },
    ];
  },
