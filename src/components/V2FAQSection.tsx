    ...
    <section className="py-16 px-4" itemScope itemType="https://schema.org/FAQPage">
      <div className="max-w-6xl mx-auto">
        <header className="text-center mb-12">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#140e02]">{data.title}</h2>
        </header>
                ...
                <div className="flex items-center gap-3 mb-4">
                  <div className="flex items-center justify-center w-12 h-12 flex-shrink-0">
                    {faq.icon?.url ? (
                      ...
                      // Fallback icon
                      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="text-[#ffbf3c]">
                  ...
                  <span className="text-sm text-[#8c877c] font-medium uppercase tracking-wide">{faq.category}</span>
                </div>

                <h3 className="text-lg sm:text-xl font-semibold text-[#140e02] mb-3 leading-tight" itemProp="name">
                  {faq.title}
                </h3>
        ...
        <footer className="text-center">
          <Button
            ...
            asChild
          >
            <a href={data.button.link} aria-label={`${data.button.text} - View all frequently asked questions`}>
              {data.button.text}
