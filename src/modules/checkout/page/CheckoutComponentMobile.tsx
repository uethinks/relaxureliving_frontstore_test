...
export const CheckoutComponentMobile = ({
    cart
}: {
  cart: StoreCart | null
}): JSX.Element => {   
  ...
  // 当购物车加载完成后，用购物车中的 email 和 billing_address 预填充表单默认值（保留用户已输入的值）
  useEffect(() => {
    if (!cart) return
    ...
    setFormData((prev) => {
      ...
      return {
        ...
        shipping_address: {
          first_name: prev.shipping_address.first_name || billing?.first_name || "",
          last_name: prev.shipping_address.last_name || billing?.last_name || "",
          address_1: prev.shipping_address.address_1 || billing?.address_1 || "",
          city: prev.shipping_address.city || billing?.city || "",
          province: prev.shipping_address.province || billing?.province || "",
          postal_code: prev.shipping_address.postal_code || billing?.postal_code || "",
          phone: prev.shipping_address.phone || billing?.phone || "",
          country_code:
            prev.shipping_address.country_code || billing?.country_code || defaultCountryCode,
        },
      }
    })
  }, [cart])
  ...
  return (
    <div className="py-4 my-4">
      {/* Contact Section */}
      <div className="mb-6">
        <h2 className="text-[20px] font-semibold text-[#111827] mb-4">Contact</h2>
      ...
      {/* Delivery Section */}
      <div className="mb-6">
        <h2 className="text-[20px] font-semibold text-[#111827] mb-4">Delivery</h2>
        ...
        <div className="space-y-4">
          ...
          {/* Name Row */}
          <div className="flex flex-col md:flex-row w-full items-start gap-3 relative">
            <div className="flex flex-col w-full">
              ...
              {errors.firstName && <div className="text-red-500 mt-1 text-sm">{errors.firstName}</div>}
            </div>
            ...
            <div className="flex flex-col w-full">
              ...
              {errors.lastName && <div className="text-red-500 mt-1 text-sm">{errors.lastName}</div>}
            </div>
          </div>

          {/* Address - Bigger with multiple rows */}
          <div className="flex flex-col w-full">
            ...
            {errors.address && <div className="text-red-500 mt-1 text-sm">{errors.address}</div>}
          </div>

          {/* City, State, ZIP */}
          <div className="flex w-full flex-col gap-3 relative flex-[0_0_auto]">
            <div className="flex flex-col w-full">
              ...
              {errors.city && <div className="text-red-500 mt-1 text-sm">{errors.city}</div>}
            </div>
            ...
            <div className="flex flex-col md:flex-row w-full gap-3">
              <div className="flex flex-col w-full">
                ...
                {errors.province && <div className="text-red-500 mt-1 text-sm">{errors.province}</div>}
              </div>
              ...
              <div className="flex flex-col w-full">
                ...
                {errors.postalCode && <div className="text-red-500 mt-1 text-sm">{errors.postalCode}</div>}
              </div>
            </div>
          </div>
