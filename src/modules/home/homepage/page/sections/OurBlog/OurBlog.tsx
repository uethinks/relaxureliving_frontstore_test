...
export const OurBlog = ({
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full items-center gap-2.5 md:gap-[98px] md:px-[47px] py-0 relative flex-[0_0_auto] ml-[-47.00px] mr-[-47.00px]">
      {/* Desktop Layout */}
      <div className="flex flex-col w-full lg:w-2/5 items-start justify-center px-0 py-4 relative">
        ...
        <div className="items-start self-stretch w-full flex flex-col gap-2.5 relative flex-[0_0_auto]">
          <div className="flex self-stretch w-full flex-col lg:items-start items-center gap-2.5 relative flex-[0_0_auto]">
            <div className="flex w-4/5 h-[41px] items-center justify-center p-2.5 bg-[#072f6c] rounded-[30px] gap-2.5 relative">
              <div className="w-fit mt-[-4.00px] mb-[-2.00px] text-[#ffffff] text-[16px] lg:text-[18px] leading-[27px] whitespace-nowrap relative [font-family:'Montserrat',Helvetica] font-medium tracking-[0]">
