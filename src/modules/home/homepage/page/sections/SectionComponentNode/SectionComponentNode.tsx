      ...
      <div className="flex w-[695px] h-[947px] items-center relative">
        ...
        <div className="w-[567px] items-center justify-center px-0 py-2.5 absolute top-[781px] left-[33px] flex gap-2.5">
          <p className="flex-1 mt-[-1.00px] [font-family:'Merriweather',Helvetica] font-bold text-[#ffffff] text-[32px] leading-[44.8px] relative tracking-[0]">
            There is nothing quite like the outdoors with Relaxure
          </p>
        </div>
      </div>
      ...
      <div className="flex w-[570px] h-[655px] items-center gap-2.5 relative">
        <div className="flex flex-col w-[570px] h-[947px] items-center justify-center gap-[30px] relative mt-[-146.00px] mb-[-146.00px] bg-[#f8f8f8] rounded-[18.16px] border-[0.91px] border-solid border-[#ffffff6e] backdrop-blur-[32.4px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(32.4px)_brightness(100%)]">
                ...
                <div className="flex flex-col w-[487.55px] items-start gap-[29.05px] relative flex-[0_0_auto]">
                  <div className="flex flex-col w-[487.55px] items-start gap-[3.63px] relative flex-[0_0_auto]">
                    <div className="flex flex-col items-start gap-[5.45px] relative self-stretch w-full flex-[0_0_auto]">
                      <div className="flex flex-col items-start gap-[5.45px] relative self-stretch w-full flex-[0_0_auto]">
                        <input
                          className="relative w-fit mt-[-0.91px] [font-family:'Inter',Helvetica] font-normal text-[#000000] text-sm tracking-[0] leading-[15.4px] whitespace-nowrap [background:transparent] border-[none] p-0"
                          htmlFor="input-1"
                          placeholder="Full name"
                          type="text"
                        />

                        <div className="items-center gap-[9.08px] px-[14.53px] py-[16.34px] flex-[0_0_auto] bg-[#ffffff] rounded-[9.08px] border-[0.91px] border-solid border-[#d8dadc] flex relative self-stretch w-full">
                          <input
                            className="relative flex-1 mt-[-0.91px] [font-family:'Inter',Helvetica] font-normal text-variable-collection-gray text-base tracking-[0] leading-[17.6px] [background:transparent] border-[none] p-0"
                            id="input-1"
                  ...
                  <div className="flex flex-col w-[487.55px] items-start gap-[3.63px] relative flex-[0_0_auto]">
                    <div className="flex-col items-start gap-[5.45px] flex-[0_0_auto] flex relative self-stretch w-full">
                      <div className="flex flex-col items-start gap-[5.45px] relative self-stretch w-full flex-[0_0_auto]">
                        ...
                        <div className="items-center gap-[9.08px] px-[14.53px] py-[16.34px] flex-[0_0_auto] bg-[#ffffff] rounded-[9.08px] border-[0.91px] border-solid border-[#d8dadc] flex relative self-stretch w-full">
                          <div className="relative flex-1 mt-[-0.91px] [font-family:'Inter',Helvetica] font-normal text-variable-collection-gray text-base tracking-[0] leading-[17.6px]">
                            +1 234 567 9010
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="flex flex-col w-[487.55px] items-start gap-[3.63px] relative flex-[0_0_auto]">
                    <div className="flex flex-col items-start gap-[5.45px] relative self-stretch w-full flex-[0_0_auto] bg-[#f6f7f9]">
                      <div className="flex flex-col items-start gap-[5.45px] relative self-stretch w-full flex-[0_0_auto]">
                        <input
                          className="relative w-fit mt-[-0.91px] [font-family:'Inter',Helvetica] font-normal text-[#000000] text-[12.7px] tracking-[0] leading-[14.0px] whitespace-nowrap [background:transparent] border-[none] p-0"
                          htmlFor="input-2"
                          placeholder="Email"
                          type="email"
                        />
                  ...
                  <div className="flex flex-col w-[488px] items-start gap-[3.63px] relative flex-[0_0_auto] mr-[-0.45px]">
                    <div className="flex flex-col h-[207px] items-start gap-[5.45px] relative self-stretch w-full">
                      <div className="flex flex-col items-start gap-[5.45px] relative self-stretch w-full flex-[0_0_auto]">
                        ...
                        <div className="flex h-[185px] items-center gap-[9.08px] px-[14.53px] py-[16.34px] relative self-stretch w-full bg-[#ffffff] rounded-[9.08px] border-[0.91px] border-solid border-[#d8dadc]">
                          <div className="absolute w-[459px] h-[18px] top-[19px] left-[15px] [font-family:'Inter',Helvetica] font-normal text-variable-collection-gray text-base tracking-[0] leading-[17.6px]">
                            example@gmail.com
                          </div>
                        </div>
                      </div>
          ...
          <div className="flex-col w-[482.1px] items-start gap-[9.08px] flex-[0_0_auto] flex relative">
            <div className="flex flex-col h-[43.58px] items-center gap-[var(--3-spacing-spacing-sm)] relative self-stretch w-full">
