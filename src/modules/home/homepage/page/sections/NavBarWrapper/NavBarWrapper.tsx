...
export const NavBarWrapper = (): JSX.Element => {
  return (
    <div className="inline-flex flex-col items-start gap-2.5 px-0 py-10 fixed top-0 left-[154px]">
        ...
        <div className="justify-between self-stretch w-full flex-[0_0_auto] mt-[-4.50px] mb-[-4.50px] flex items-center relative">
          ...
          <div className="flex w-[200px] items-center justify-end gap-5 relative">
            <div className="flex items-center justify-end gap-2.5 relative flex-1 grow ml-[-20.00px]">
              <div className="inline-flex items-center justify-center gap-2.5 p-2.5 relative flex-[0_0_auto] ml-[-437.00px]">
              ...
              <div className="inline-flex items-center justify-center gap-2.5 p-2.5 relative flex-[0_0_auto] ml-[-269.00px]">
              ...
              <div className="flex w-[101px] items-center justify-center gap-2.5 px-0 py-2.5 relative ml-[-100.00px]">
