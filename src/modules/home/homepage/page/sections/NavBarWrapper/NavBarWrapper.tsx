...
export const NavBarWrapper = (): JSX.Element => {
  ...
  return (
    <div className="w-full lg:w-[780px] xl:w-[900px] 2xl:w-[1205px] inline-flex flex-col items-start gap-2.5 px-0 py-4 lg:py-10 lg:fixed lg:top-0 lg:left-1/2 lg:-translate-x-1/2 z-50">
      {/* Desktop Navigation */}
