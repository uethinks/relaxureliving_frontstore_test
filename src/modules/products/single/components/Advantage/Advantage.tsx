export const Advantage = (): JSX.Element => {
  return (
    <div className="relative w-full flex flex-col items-start gap-2.5 px-2 lg:px-5 py-2.5 lg:py-5 self-stretch overflow-hidden lg:border lg:border-[#F6AF1F] rounded-[20px]">
      ...
      <div className="flex md:hidden gap-y-1 w-full text-[12px]">
        <div className="flex items-start justify-center w-full">
          <h3 className="[font-family:'Montserrat',Helvetica] font-medium text-[#69727a] text-center tracking-[0] leading-6">
            <p>Free delivery</p>
            <p>Full insurance</p>
          </h3>
        </div>
