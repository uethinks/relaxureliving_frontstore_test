...
interface V2GlassDoorsSelectorProps {
...
export const V2GlassDoorsSelector: React.FC<V2GlassDoorsSelectorProps> = ({
  glassdoorProduct,
  glassdoorCMSData,
  pergolaSizes,
  pergolaSize,
  ...
  }, [glassdoorProduct, selectedPergolaSize, selectedColor])
