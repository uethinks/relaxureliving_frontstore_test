...
export const AccessoriesCards = ({
  ...
  return (
    <div className="flex flex-col w-full items-center justify-center gap-10 relative mt-10">
      <div className="flex flex-col w-full items-center gap-5 relative flex-[0_0_auto]">
        <div className="flex flex-col w-full h-[100px] items-start relative">
          <div className="flex items-center justify-center gap-2.5 px-2.5 py-0 relative self-stretch w-full flex-[0_0_auto]">
            <div
              className={`relative w-full mt-[-1.00px] font-heading-2 font-[number:var(--heading-2-font-weight)] 
        ...
        {productAccessories?.productAccessoryItem.map((item) => (
          ...
          >
            <div className="flex justify-center items-center relative rounded-[20px] mb-10">
              <div
                className={`flex flex-col w-[90%] items-center gap-5 relative bg-[#00000069] 
                rounded-[20px] border border-solid border-[#ffffff70] backdrop-blur-[14.1px] 
                backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(14.1px)_brightness(100%)]`}
              >
                <div className="flex flex-col items-center gap-2 p-2.5 relative self-stretch w-full">
                  ...
                  <div className="flex items-center gap-2.5 relative self-stretch w-full flex-[0_0_auto]">
                    <p
                      className={`w-full mr-[-55.00px] text-[#ffffff] relative mt-[-1.00px] font-relaxure-sub-heading-18 
                      font-[number:var(--relaxure-sub-heading-18-font-weight)] text-[length:var(--relaxure-sub-heading-18-font-size)] 
                      tracking-[var(--relaxure-sub-heading-18-letter-spacing)] leading-[var(--relaxure-sub-heading-18-line-height)] 
      ...
      <div className="flex items-center justify-center gap-2.5 px-2.5 py-0 relative self-stretch w-full flex-[0_0_auto]">
        <div
          className={`relative w-full lg:w-2/3 mt-[-1.00px] font-heading-2 font-[number:var(--heading-2-font-weight)] 
            text-[#343a40] text-[18px] lg:text-[36px] text-center tracking-[var(--heading-2-letter-spacing)] 
            leading-[var(--heading-2-line-height)] [font-style:var(--heading-2-font-style)]`}
        >
