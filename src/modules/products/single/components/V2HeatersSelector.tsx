...
interface V2HeatersSelectorProps {
...
export const V2HeatersSelector: React.FC<V2HeatersSelectorProps> = ({
  heaterProduct,
  heaterCMSData,
}) => {
  ...
  // 获取颜色选项
  const heaterColors = heaterProduct?.options?.find(
  ...
  const getVariant = useCallback(() => {
    return heaterProduct?.variants?.filter((variant) => {
          ...
          <div className="mt-8 mb-6">
            ...
            <div className="flex flex-col items-start gap-5">
              <div className="text-sm font-medium text-[#000000] flex justify-between w-full">
                <span> Heater: {manualQuantity}</span>
