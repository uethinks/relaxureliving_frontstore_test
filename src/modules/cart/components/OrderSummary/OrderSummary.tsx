...
export const OrderSummary = (): JSX.Element => {
  ...
  return (
    <div className="flex flex-col w-[490px] items-start gap-2.5 px-2.5">
      <div className="flex flex-col items-start justify-center gap-5 p-5 relative self-stretch w-full flex-[0_0_auto] bg-[#efefef] rounded-[20px] shadow-shadow-relaxure-button">
        ...
        <div className="flex flex-col w-[431px] items-center gap-[35px] relative mr-[-1.00px]">
          <div className="flex flex-col items-start gap-10 relative self-stretch w-full flex-[0_0_auto]">
            <div className="flex flex-col items-start gap-[30px] relative self-stretch w-full flex-[0_0_auto]">
              <div className="flex flex-col items-start gap-[30px] relative self-stretch w-full flex-[0_0_auto]">
                {cart?.items?.map((item) => (
                  ...
                  >
                    <div className="flex w-[75px] h-6 items-center gap-2.5 relative">
                      <div className="relative w-[327px] h-6 mt-[-1.00px] mr-[-252.00px] [font-family:'Montserrat',Helvetica] font-medium text-[#343a40] text-base tracking-[0] leading-6 whitespace-nowrap">
                ...
                <div className="flex justify-between items-center gap-[175px] relative self-stretch w-full flex-[0_0_auto]">
                  <div className="flex w-[107px] items-center justify-start gap-[98px] relative">
                    <div className="flex w-[75px] h-6 items-center gap-2.5 relative">
                      <div className="relative w-[327px] h-6 mt-[-1.00px] mr-[-252.00px] [font-family:'Montserrat',Helvetica] font-medium text-[#343a40] text-base tracking-[0] leading-6 whitespace-nowrap">
                        Delivery Fee
                      </div>
