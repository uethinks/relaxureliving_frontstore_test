...
export const ProductCardMobile = (): JSX.Element | null => {
  ...
  return (
    <>
      {pergola.map((item) => (
        <div
          key={item.id}
          className="full flex flex-row items-start gap-2 border-t border-white"
        >
          <div
          ...
          <div className="flex flex-col items-start justify-between gap-1 relative flex-1 pt-3 ">
            <div className="flex flex-row items-start lg:items-start justify-between relative self-stretch w-full flex-[0_0_auto]">
