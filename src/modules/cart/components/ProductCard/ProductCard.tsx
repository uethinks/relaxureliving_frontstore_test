  ...
  return (
    <>
      {pergola.map((item) => (
        <div
          key={item.id}
          className="full flex flex-col md:flex-row items-center gap-5 p-5 rounded-[20px] bg-[#F3F3F3]"
        >
          <div
          ...
          <div className="flex flex-col w-full md:w-2/3 items-start gap-4 relative">
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between relative self-stretch w-full flex-[0_0_auto]">
              ...
              <div className="inline-flex items-center justify-center gap-2.5 lg:px-2.5 py-0 relative flex-[0_0_auto]">
