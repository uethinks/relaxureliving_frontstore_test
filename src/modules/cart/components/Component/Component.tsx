...
export const Component = ({
  ...
  return (
    <button
      className={`all-[unset] box-border w-[200px] flex items-center gap-2 
        shadow-shadow-relaxure-button px-6 py-3 rounded-[10px] justify-center relative 
        ${
          property1 === "primary-button-hover-l"
            ? "bg-[#0a3980]"
            : property1 === "primary-button-pressed-l"
            ? "bg-[#062e6b]"
            : "bg-[#072f6c]"
        } ${className}`}
    >
