...
export const Frame1000004815 = ({
  property1,
  frameClassName,
}: Props): JSX.Element => {
  return (
    <div
      className={`border border-solid border-[#a8a8a8] flex flex-col items-start relative ${property1 === "variant-2" ? "w-[390px]" : "w-[374px]"} ${property1 === "variant-2" ? "gap-[20.86px]" : "gap-5"} ${property1 === "variant-2" ? "shadow-[0px_3.13px_7.3px_#072f6c1a,0px_13.56px_13.56px_#072f6c17,0px_30.24px_17.73px_#072f6c0d,0px_53.19px_20.86px_#072f6c03,0px_83.43px_22.94px_transparent]" : ""} ${property1 === "variant-2" ? "p-[10.43px]" : "p-2.5"} ${property1 === "variant-2" ? "h-[504px]" : "h-[484px]"} ${property1 === "variant-2" ? "rounded-[20.86px]" : "rounded-[20px]"} ${property1 === "variant-2" ? "bg-[#ffffff]" : ""}`}
    >
      <div
        className={`border-[#e8e8ea] w-full self-stretch grow bg-cover flex-1 bg-[50%_50%] relative ${property1 === "variant-2" ? "border-[1.24px] border-solid" : "border-[1.19px] border-solid"} ${property1 === "variant-2" ? "bg-[url(https://c.animaapp.com/m8o9g6iofzwjOy/img/frame-86-1.svg)]" : (property1 === "variant-3") ? "bg-[url(https://c.animaapp.com/m8o9g6iofzwjOy/img/frame-86.svg)]" : "bg-[url(https://c.animaapp.com/m8o9g6iofzwjOy/img/frame-86-2.svg)]"} ${property1 === "variant-2" ? "rounded-[19.9px]" : "rounded-[19.08px]"} ${frameClassName}`}
      />
