...
export const Button = ({ text, onClick }: Props): JSX.Element => {
  return (
    <button
      onClick={onClick}
      className={`w-full hover:bg-[#0a3980] bg-[#F6AF1F] all-[unset] box-border flex items-center gap-2 shadow-shadow-relaxure-button px-6 py-3 rounded-[10px] justify-center relative`}
    >
