  ...
  theme: {
  	extend: {
  		colors: {
  			...
  			'1-color-modes-colors-text-text-white': 'var(--1-color-modes-colors-text-text-white)',
  			...
  			'primitive-color-neutral-neutral-darkest': 'var(--primitive-color-neutral-neutral-darkest)',
  			...
  			'primitives-colors-gray-light-mode-950': 'var(--primitives-colors-gray-light-mode-950)',
  			'semantic-background-color-error': 'var(--semantic-background-color-error)',
  			'semantic-background-color-secondary': 'var(--semantic-background-color-secondary)',
  			'semantic-background-color-success': 'var(--semantic-background-color-success)',
  			...
  			'variable-collection-beige-brand': 'var(--variable-collection-beige-brand)',
  			'variable-collection-beige-brand-duplicate': 'var(--variable-collection-beige-brand-duplicate)',
  			'variable-collection-dark-brown': 'var(--variable-collection-dark-brown)',
  			'variable-collection-dark-green-brand': 'var(--variable-collection-dark-green-brand)',
  			'variable-collection-dark-green-brand-duplicate': 'var(--variable-collection-dark-green-brand-duplicate)',
